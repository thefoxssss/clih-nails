...
A lightweight browser app for making car crash diagrams similar to police collision sketches.
...
- Physics-based crash playback using placed vehicles, selectable moving units, direction controls, speed sliders, and post-impact sliding/skid behavior
